...
#ifndef CPROVER_2LS_SOLVER_SUMMARIZER_BW_CEX_WP_H
#define CPROVER_2LS_SOLVER_SUMMARIZER_BW_CEX_WP_H
...
#endif // CPROVER_2LS_SOLVER_SUMMARIZER_BW_CEX_WP_H
