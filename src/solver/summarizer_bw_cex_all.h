...
#ifndef CPROVER_2LS_SOLVER_SUMMARIZER_BW_CEX_ALL_H
#define CPROVER_2LS_SOLVER_SUMMARIZER_BW_CEX_ALL_H
...
#endif // CPROVER_2LS_SOLVER_SUMMARIZER_BW_CEX_ALL_H
